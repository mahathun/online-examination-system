...
<body>
  ...
  <div id="wrapper">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <li ><a href="userConsole.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
          <li >
            ';
            if($userType=="Student"){
              echo '<a href="applyExam.php"><i class="glyphicon glyphicon-share"></i> Apply for an Exam</a>';
            }elseif ($userType=="Teacher") {
              echo '<a  href="viewStudents.php"><i class="glyphicon glyphicon-user"></i> View Students</a>';
            }

          echo '</li>
          <li>';
            if($userType=="Student"){
              echo '<a href="sitExam.php"><i class="glyphicon glyphicon-edit"></i> Sit For an Exam</a>';
            }
            // elseif ($userType=="Teacher") {
            //   echo '<a href="editPaper.php"><i class="glyphicon glyphicon-edit"></i> Edit Paper</a>';
            // }
          ...
          <li class="active">
            ';
            if($userType=="Student"){
              echo '<a href="checkResults.php"><i class="glyphicon glyphicon-check"></i> Check Results</a>';
            }elseif ($userType=="Teacher") {
              echo '<a href="createPaper.php"><i class="glyphicon glyphicon-new-window"></i> Create Paper</a>';
            }
          ...
          ';
            if($userType=="Teacher"){
              echo '<li>
                      <a href="viewMark.php"><i class="glyphicon glyphicon-check"></i> View / Mark </a>
                    </li>

                    <li>
                      <a href="summery.php"><i class="glyphicon glyphicon-th-list"></i> View Summery </a>
                    </li>';
            }
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1>CREATE <small>Paper</small></h1>
          <ol class="breadcrumb">
            <li class="active"><i class="fa fa-dashboard"></i> Create Paper</li>
          </ol>
  ...
  <div class="row">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Create a Paper : '.date("M d Y").'</h3>
        </div>
        <div class="panel-body">
          <form name="createPaper" action="create-exam-paper.php" method="POST">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-10">
              ...
              <input type="text" required class="form-control input-sm" name="courseTitle"> 
            </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-10">
              ...
              <input type="text" required class="form-control input-sm" name="courseCode"> 
            </div>
           
          </div>
          <div class="row form-group">
            <div class="col-md-2">Time Allowed</div>
            <div class="col-md-10">
          
              <input type="text" required class="form-control input-sm" placeholder="30 minutes" name="timeAllowed"> 
            </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-10">
              ...
              <input type="text" required class="form-control input-sm" name="totalMarks"> 
            </div>
           
          </div>
          <div class="row form-group">
            <div class="col-md-2">Examination Type</div>
            <div class="col-md-10">
          
              <select name="examinationType"  class="form-control input-sm">
                                <option >quiz</option>
                                <option >mid</option>
                                <option >end</option>
          ...
          <div class="row form-group">    
              <div class="col-md-12">
                <button name="submit" onclick="createPaper.submit();" class="btn btn-primary">Create</a>
              </div>
          </div>
