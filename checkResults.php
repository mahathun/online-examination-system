...
<body>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <li ><a href="userConsole.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
          ...
          <li class="active"><a href="checkResults.php"><i class="glyphicon glyphicon-check"></i> Check Results</a></li>
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1>RESULTS <small>check</small></h1>
          <ol class="breadcrumb">
            <li class="active"><i class="glyphicon glyphicon-check"></i> Check results</li>
          </ol>
    ...
    <div class="col-lg-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Check Results : '.date("M d Y").'</h3>
        </div>
        ...
        echo '
              ...
              <form action="check-student-results.php" name="checkResults" method="POST" >
                ...
                <div class="row form-group student-only">
                          ...
                          <div class="row form-group student-only">
                            ...
                            <div class="col-md-9">
                              ...
                              <select id="id_select" name="subject" class="form-control input-sm" >
                                <option ';if(contain($subjects,"Physics")){echo 'selected';} echo '>Physics</option>
                                <option ';if(contain($subjects,"Mathematics")){echo 'selected';} echo '>Mathematics</option>
                                <option ';if(contain($subjects,"Chemistry")){echo 'selected';} echo '>Chemistry</option>
                                <option ';if(contain($subjects,"Computer Science")){echo 'selected';} echo '>Computer Science</option>
                          ...
                          <div class="row form-group student-only">
                            ...
                            <div class="col-md-9" >
                              ...
                              <select  id="id_select1" name="courseCode" class="form-control input-sm"  >
                                <optgroup label="Mathematics" data-subtext="Courses" data-icon="icon-ok" >
                                  <option ';if(contain($coursesRegistered,"MT100")){echo 'selected';} echo '>MT100</option>
                                  <option ';if(contain($coursesRegistered,"MT101")){echo 'selected';} echo '>MT101</option>
                                  <option ';if(contain($coursesRegistered,"MT102")){echo 'selected';} echo '>MT102</option>
                          ...
                          <div class="row form-group student-only">
                            <label class="col-md-3 control-label">Examination Type</label>

                            <div class="col-md-9" >

                              <select  id="id_select1" name="examinationType" class="form-control input-sm"  >
                          ...
                          <div class="row form-group">
                            <div class="col-md-4 col-md-offset-5">
                              <a href=""  onclick="checkResults.submit();" class="btn btn-primary"><span class="glyphicon glyphicon-list-alt"></span> Check Results</a>
...
';
              ...
              if(isset($_GET['marks'])){
                ...
                //echo "TRUE".$examId.$email.$marks;

                $query2 = "SELECT * FROM `exams` WHERE `examId` = '$examId'";
                $row = mysql_fetch_array(mysql_query($query2)) or die("Error");
                ...
                echo'
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="panel panel-primary">
                        <div class="panel-heading">
                          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Results of  '.$row['courseCode'].'</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-5 text-center">
                                  ...
                                  <div class="col-md-12">
                                      <div class="progress">
                                        <div class="progress-bar progress-bar-striped active"  role="progressbar" aria-valuenow="'.$marks.'" aria-valuemin="0" aria-valuemax="100" style="width: '.$marks.'%">
                            ...
                            <div class="col-md-7">
                                <div class="col-md-12"><strong>Course Code </strong>- '.$row['courseCode'].'</div>
                                <div class="col-md-12"><strong>Course Title </strong>- '.$row['courseTitle'].'</div>
                                <div class="col-md-12"><strong>Subject </strong>- '.$row['subject'].'</div>
                                <div class="col-md-12"><strong>Examination Type </strong>- '.$row['examinationType'].'</div>
                                <div class="col-md-12"><strong>Year </strong>- '.$row['year'].'</div>
                                <div class="col-md-12"><strong>Semester </strong>- '.$row['semester'].'</div>
