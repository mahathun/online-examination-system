...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1>VIEW / MARK <small>Paper</small></h1>
          <ol class="breadcrumb">
            <li class="active"><i class="fa fa-dashboard"></i> View/Mark Paper</li>
          </ol>
  ...
  <div class="row">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> View / Mark Paper </h3>
        </div>
        <div class="panel-body">
          <form name="viewPaper" target="_blank" action="view-exam-paper.php" method="POST">
          ...
          <div class="row form-group">
            <div class="col-md-2">Student Reg. No.</div>
            <div class="col-md-10">
          
              <input type="text" required class="form-control input-sm" placeholder="S/08/404" name="studentRegNo"> 
            </div>
          ...
          <div class="row form-group">    
              <div class="col-md-12">
                <button name="submit" onclick="viewPaper.submit();" class="btn btn-primary">View</a>
              </div>
          </div>
