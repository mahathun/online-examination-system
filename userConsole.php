      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="alert alert-success alert-dismissable">
            ...
            Welcome to Online Examination System(OLE).
          </div>
        </div>
      ...
      <div class="col-lg-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Available Requests</h3>
          </div>
            ...
            <table class="table table-hover" style="font-size:12px;">
               ...
               $counter=1;
                while($row = mysql_fetch_array($results)){
                  ...
                  <form name="formreg'.$counter.'" action="approve-user.php" method="POST">
                          <tr>
                            <td>'.$row['fname'].'</td>
                            <td>'.$row['lname'].'</td>
                            <td>'.$row['userType'].'</td>
                            
                            <td><a href="" onclick="formreg'.$counter.'.submit();"><i class="fa fa-arrow-circle-right"></i> Approve </a>
                                <a href="" onclick="$(\'#approvement\').val(\'delete\');formreg'.$counter.'.submit();"><i class="fa fa-arrow-circle-right"></i> Delete </a>
                                </td>
                          </tr>
                          <input readonly class="hidden" type="text" id="approvement" name="approvement" value="">
                          <input readonly class="hidden" type="text" name="registrantUserType" value="'.$row["userType"].'">
                          <input readonly class="hidden" type="text" name="email" value="'.$row['email'].'">
                        </form>
                        ';
                        $counter += 1;
                }
