  ...
  <div class="row">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <form name="summery" action="summery.php" method="POST">
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <div class="col-md-2"><button name="submit" onclick="summery.submit();" class="btn btn-primary">Show</a></div>
          </div>
    ...
    if(isset($_POST['submit'])){
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Results of '.$course. ' : '.date("M d Y").'</h3>
        </div>
        <div class="panel-body">
        <table class="table table-hover" style="font-size:12px;">
              ...
              <tbody>
            ';
            $q = "SELECT * FROM `users` INNER JOIN `students` ON users.email = students.email INNER JOIN `marks` ON users.email = marks.email INNER JOIN `exams` ON marks.examId = exams.examId WHERE `courseCode` = '$course' ";
                        ...
                        <div class="progress-bar progress-bar-';
                                    if($marks>=75){
                                      ...
                                      echo "danger";
                                          ...
                                          echo '" role="progressbar" aria-valuenow="'.$marks.'" aria-valuemin="0" aria-valuemax="100" style="width: '.$marks.'%">
                          '.$marks.'%
                        </div>
                      </div>
